...
// Destinatário
$para = "guilhermeviana347@gmail.com";

// Assunto do e-mail
$assunto = "Contato do através do site Voluntários Contra Covid";
...
if (!empty($nome) && !empty($email) && !empty($mensagem)) {
    ...
    echo "<script>alert('$msg');window.location.assign('file:///E:/Gest%C3%A3o%20Empreendedora/index.html');</script>";
} else {
